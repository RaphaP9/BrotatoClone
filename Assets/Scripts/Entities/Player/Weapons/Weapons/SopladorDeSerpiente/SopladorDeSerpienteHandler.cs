...
public class SopladorDeSerpienteHandler : RangedWeaponHandler
{
    [Header("Components")]
    [SerializeField] private Transform firePoint;
    [SerializeField] private Transform projectilePrefab;

    public event EventHandler OnSopladorDeSerpienteAttack;

    protected override void Attack()
    {
        ShootProjectile(projectilePrefab, firePoint, weaponAim.AimDirection);
        OnSopladorDeSerpienteAttack?.Invoke(this, EventArgs.Empty);
    }
