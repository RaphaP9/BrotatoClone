...
public class GhostMeleeEnemyAnimationController : MonoBehaviour
{
    [Header("Components")]
    ...
    private const string GHOST_RUN_ANIMATION_NAME = "GhostRun";
    ...
    private void MeleeEnemyGhosting_OnThisEnemyGhosting(object sender, System.EventArgs e)
    {
        if (hasDied) return;
        animator.Play(GHOST_RUN_ANIMATION_NAME);
    }
